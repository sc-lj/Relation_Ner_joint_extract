...
parser.add_argument('--model_name', type=str, default='casglobal', help='name of the model')
...
model = {
    ...
    "casglobalpointer":models.CasGlobalPointer,
    "casnew": models.CasNewSub,
    "joint":models.JointSubObj,
    "casglobal":models.CasGlobal
}
